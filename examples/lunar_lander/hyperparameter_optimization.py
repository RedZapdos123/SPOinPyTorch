#!/usr/bin/env python3
"""
Hyperparameter optimization script for SPO agent using Optuna.

This script demonstrates how to use Optuna to optimize hyperparameters
for the SPO algorithm on LunarLanderContinuous-v3.

Usage:
    python hyperparameter_optimization.py

The script will run multiple trials and save the best hyperparameters.
"""
...
def objective(trial):
    ...
    config = {
        ...
        "seed": 17,
        "total_timesteps": 200_000,  # Reduced for faster optimization
...
def main():
    ...
    print("This may take several hours depending on the number of trials")
